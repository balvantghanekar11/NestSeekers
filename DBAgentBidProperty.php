        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="heading-properties-3">
                    ...
                    <div class="mb-30"><span class="property-price">₹&nbsp;<?php 
                                        ...
                                        ?> /-</span> <span class="rent">For <?php echo $Fetch_Property['Status'];?></span> <span class="location"><i class="flaticon-pin"></i><?php  echo $Fetch_Property['Address']; ?></span></div>
                </div>
            </div>
        </div>
        <div class="row">
