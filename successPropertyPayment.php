    ...
    <div class="container">
        <div class="breadcrumb-area">
            ...
            <ul class="breadcrumbs">
                ...
                <li class="active">Property Payment Receipt</li>
            </ul>
        </div>
    </div>
</div>
...
if (isset($_REQUEST['btnMyPropertis'])) 
{
  ...
  /*insert into tblInvoice*/
   ...
   /*Send Email To Owner Thankyou For submit new property*/
                ...
                $msg="WelCome To NestSeekers Real Estate Website, 
                Your Property Post Payment is Succefully Done.
                Now Your Property Post is live.";
